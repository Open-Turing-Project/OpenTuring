...
typedef	TLnat4	TL_TLA___x422[11];
extern TL_TLA___x422	TL_TLA_TLARS;
...
TLreal8 TL_TLA_TLA8CD (angle)
TLreal8	angle;
{
    TLreal8	radAngle;
    radAngle = angle * 0.0174532925199432957692366;
    if (( TLSIMPLEABS(radAngle)) > 0.84331486e9) {
	TL_TLQUIT("Argument too large in \"cosd\"", (TLint4) 100);
    };
    return (TL_TLA_TLA8T((TLreal8) radAngle, (TLreal8) (( TLSIMPLEABS(radAngle)) + 1.57079632679489661923), (TLint4) 1));
    /* NOTREACHED */
}
