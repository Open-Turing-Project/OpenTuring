...
typedef	TLaddressint	TL_TLI___x530[21];
typedef	TL_TLI___x530	TL_TLI_ArgList;
typedef	TLchar	TL_TLI___x533[16];
typedef	TL_TLI___x533	TL_TLI___x532[3];
typedef	struct TL_TLI_StreamEntryType	TL_TLI___x534[33];
extern TL_TLI___x534	TL_TLI_TLIS;
...
typedef	TLchar	TL_TLI___x538[42];
extern TL_TLI___x538	TL_TLI_TLIPXL;
typedef	TLchar	TL_TLI___x539[44];
extern TL_TLI___x539	TL_TLI_TLIPXN;
...
void TL_TLI_TLIPR (putWidth, putItem, streamNo)
TLint4	putWidth;
TLreal8	putItem;
TLint2	streamNo;
{
    ...
    {
	TLstring	__x542;
	TL_TLS_TLSVRS((TLreal8) putItem, (TLint4) putWidth, __x542);
	(*TL_TLI_TLIFPS)(__x542, (TLaddressint) (TL_TLI_TLIS[streamNo - -2].info));
    };
}
