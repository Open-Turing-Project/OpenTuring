...
typedef	TLnat4	TL_TLA___x416[11];
extern TL_TLA___x416	TL_TLA_TLARS;
...
TLreal8 TL_TLA_TLA8AD (right, left)
TLreal8	right;
TLreal8	left;
{
    TL_TLQUIT("TLA8AD unimplemented", (TLint4) 60);
    /* NOTREACHED */
}
