...
typedef	TLnat4	TL_TLA___x540[11];
extern TL_TLA___x540	TL_TLA_TLARS;
...
void TL_TLA_TLARSC (answer, seqNo)
TLreal8	*answer;
TLint4	seqNo;
{
    TLBINDREG((*value), TLnat4);
    TLreal8	tmp;
    value = &(TL_TLA_TLARS[seqNo]);
    (*value) *= 1664525;
    tmp = (*value);
    (*answer) = TL_TLA_TLA8SX((TLreal8) tmp, (TLint4) (TL_TLA_TLA8GX((TLreal8) tmp) - 32));
}
