...
typedef	TLaddressint	TL_TLI___x559[21];
typedef	TL_TLI___x559	TL_TLI_ArgList;
typedef	TLchar	TL_TLI___x562[16];
typedef	TL_TLI___x562	TL_TLI___x561[3];
typedef	struct TL_TLI_StreamEntryType	TL_TLI___x563[33];
extern TL_TLI___x563	TL_TLI_TLIS;
...
typedef	TLchar	TL_TLI___x567[42];
extern TL_TLI___x567	TL_TLI_TLIPXL;
typedef	TLchar	TL_TLI___x568[44];
extern TL_TLI___x568	TL_TLI_TLIPXN;
...
void TL_TLI_TLITL (position, streamNo)
TLint4	*position;
TLint4	streamNo;
{
    TL_Cint	lastOp;
    lastOp = TL_TLI_TLIS[streamNo - -2].lastOp;
    TL_TLI_TLISS((TLint4) streamNo, (TL_Cint) 0);
    TL_TLI_TLIS[streamNo - -2].lastOp = lastOp;
    (*position) = (*TL_TLI_TLIFTL)((TLaddressint) (TL_TLI_TLIS[streamNo - -2].info));
}
