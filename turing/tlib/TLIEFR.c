...
typedef	TLaddressint	TL_TLI___x436[21];
typedef	TL_TLI___x436	TL_TLI_ArgList;
typedef	TLchar	TL_TLI___x439[16];
typedef	TL_TLI___x439	TL_TLI___x438[3];
typedef	struct TL_TLI_StreamEntryType	TL_TLI___x440[33];
extern TL_TLI___x440	TL_TLI_TLIS;
...
typedef	TLchar	TL_TLI___x444[42];
extern TL_TLI___x444	TL_TLI_TLIPXL;
typedef	TLchar	TL_TLI___x445[44];
extern TL_TLI___x445	TL_TLI_TLIPXN;
...
TLint4	streamNo;
{
	...
	{
	    TLstring	__x447;
	    TL_TLS_TLSVIS((TLint4) streamNo, (TLint4) 1, (TLint4) 10, __x447);
	    {
		TLstring	__x446;
		TL_TLS_TLSCAT("Reset of eof attempted on illegal stream number ", __x447, __x446);
		TL_TLQUIT(__x446, (TLint4) 73);
	    };
	};
    };
	...
	{
	    TLstring	__x449;
	    TL_TLS_TLSVIS((TLint4) streamNo, (TLint4) 1, (TLint4) 10, __x449);
	    {
		TLstring	__x448;
		TL_TLS_TLSCAT("Reset of eof attempted on unopened stream number ", __x449, __x448);
		TL_TLQUIT(__x448, (TLint4) 77);
	    };
	};
    };
	...
	{
	    TLstring	__x451;
	    TL_TLS_TLSVIS((TLint4) streamNo, (TLint4) 1, (TLint4) 10, __x451);
	    {
		TLstring	__x450;
		TL_TLS_TLSCAT("Reset of EOF attempted on closed stream number ", __x451, __x450);
		TL_TLQUIT(__x450, (TLint4) 75);
	    };
	};
    };
	...
	if ((streamMode & ((TLSMLSMLSETCONST(1) | TLSMLSMLSETCONST(3)))) == 0) {
	    {
		TLstring	__x453;
		TL_TLS_TLSVIS((TLint4) streamNo, (TLint4) 1, (TLint4) 10, __x453);
		{
		    TLstring	__x452;
		    TL_TLS_TLSCAT("Reset of eof attempted on incompatible stream number ", __x453, __x452);
		    TL_TLQUIT(__x452, (TLint4) 76);
		};
	    };
	};
    };
    (*TL_TLI_TLIFZ)((TLaddressint) (TL_TLI_TLIS[streamNo - -2].info));
    TL_TLI_TLIS[streamNo - -2].atEof = 0;
}
