...
typedef	TLaddressint	TL_TLI___x442[21];
typedef	TL_TLI___x442	TL_TLI_ArgList;
typedef	TLchar	TL_TLI___x445[16];
typedef	TL_TLI___x445	TL_TLI___x444[3];
typedef	struct TL_TLI_StreamEntryType	TL_TLI___x446[33];
extern TL_TLI___x446	TL_TLI_TLIS;
...
typedef	TLchar	TL_TLI___x450[42];
extern TL_TLI___x450	TL_TLI_TLIPXL;
typedef	TLchar	TL_TLI___x451[44];
extern TL_TLI___x451	TL_TLI_TLIPXN;
...
TLboolean TL_TLI_TLIEOF (streamNo)
TLint4	streamNo;
{
    TL_TLI_StreamModeSet	streamMode;
	...
	{
	    TLstring	__x453;
	    TL_TLS_TLSVIS((TLint4) TL_TLI_TLIXSN, (TLint4) 1, (TLint4) 10, __x453);
	    {
		TLstring	__x452;
		TL_TLS_TLSCAT("Eof attempted on illegal stream number ", __x453, __x452);
		TL_TLQUIT(__x452, (TLint4) 73);
	    };
	};
    };
	...
	{
	    TLstring	__x455;
	    TL_TLS_TLSVIS((TLint4) TL_TLI_TLIXSN, (TLint4) 1, (TLint4) 10, __x455);
	    {
		TLstring	__x454;
		TL_TLS_TLSCAT("Eof attempted on unopened stream number ", __x455, __x454);
		TL_TLQUIT(__x454, (TLint4) 77);
	    };
	};
    };
	...
	{
	    TLstring	__x457;
	    TL_TLS_TLSVIS((TLint4) TL_TLI_TLIXSN, (TLint4) 1, (TLint4) 10, __x457);
	    {
		TLstring	__x456;
		TL_TLS_TLSCAT("Eof attempted on closed stream number ", __x457, __x456);
		TL_TLQUIT(__x456, (TLint4) 75);
	    };
	};
    };
	...
	TLint4	sn;
	sn = streamNo;
	TL_TLI_TLIOS(&(sn), (TL_TLI_StreamModeSet) 0x2, (TLboolean) 1);
    } else {
	if ((streamMode & ((TLSMLSMLSETCONST(1) | TLSMLSMLSETCONST(3)))) == 0) {
	    {
		TLstring	__x459;
		TL_TLS_TLSVIS((TLint4) TL_TLI_TLIXSN, (TLint4) 1, (TLint4) 10, __x459);
		{
		    TLstring	__x458;
		    TL_TLS_TLSCAT("Eof attempted on incompatible stream number ", __x459, __x458);
		    TL_TLQUIT(__x458, (TLint4) 76);
		};
	    };
	};
    };
	...
	if (ch == -1) {
	    ...
	    (*TL_TLI_TLIFUG)((TL_Cint) ch, (TLaddressint) ((*stream).info));
	};
	(*stream).lastOp = 1;
    };
    return ((*stream).atEof);
