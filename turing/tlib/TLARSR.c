...
typedef	TLnat4	TL_TLA___x548[11];
extern TL_TLA___x548	TL_TLA_TLARS;
...
void TL_TLA_TLARSR (answer, seqNo)
TLreal8	*answer;
TLint4	seqNo;
{
    if ((seqNo <= 0) || (seqNo > 10)) {
	{
	    TLstring	__x561;
	    TL_TLS_TLSVIS((TLint4) 10, (TLint4) 1, (TLint4) 10, __x561);
	    {
		TLstring	__x560;
		TL_TLS_TLSVIS((TLint4) seqNo, (TLint4) 1, (TLint4) 10, __x560);
		{
		    TLstring	__x559;
		    TL_TLS_TLSCAT("Sequence number ", __x560, __x559);
		    {
			TLstring	__x558;
			TL_TLS_TLSCAT(__x559, "passed to \"randnext\" not in range 1..", __x558);
			{
			    TLstring	__x557;
			    TL_TLS_TLSCAT(__x558, __x561, __x557);
			    TL_TLQUIT(__x557, (TLint4) 102);
			};
		    };
		};
	    };
    ...
    TL_TLA_TLARSC(&((*answer)), (TLint4) seqNo);
}
