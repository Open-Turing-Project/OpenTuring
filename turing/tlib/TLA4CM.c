...
typedef	TLnat4	TL_TLA___x381[11];
extern TL_TLA___x381	TL_TLA_TLARS;
extern TLint4	TL_TLA_TLA8HI;
extern TLint4	TL_TLA_TLA8LO;
TLint4 TL_TLA_TLA4CM (right, left)
TLnat4	right;
TLnat4	left;
{
    TLnat2	lExponent;
    ...
    lMantissa = (left & 8388607) >> 0;
    rExponent = (right & 2139095040) >> 23;
    rMantissa = (right & 8388607) >> 0;
    if (((left & (TLint4) -0x80000000) >> 31) != ((right & (TLint4) -0x80000000) >> 31)) {
	if ((((lExponent == 0) && (lMantissa == 0)) && (rExponent == 0)) && (rMantissa == 0)) {
	    return (0);
	} else {
	    if (((left & (TLint4) -0x80000000) >> 31) != 0) {
		return (-1);
	    } else {
		return (1);
	    };
