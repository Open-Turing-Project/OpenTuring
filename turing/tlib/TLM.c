...
typedef	struct TL_TLM_TL_ConditionDescriptor	TL_TLM___x389[65535];
typedef	TLint4	TL_TLM_Signalled;
typedef	TLint4	TL_TLM_OnEntryQ;
struct TL_TLM_TL_MonitorDescriptor	*TL_TLM_TLMMLH;
TL_TL_lock_t	TL_TLM_TLMMLL;

extern TLnat4 TL_TLM_TLMCLEN ();

extern TLboolean TL_TLM_TLMCEMP ();

extern void TL_TLM_TLMUDUMP ();

extern void TL_TLM_TLMGNEP ();

extern void TL_TLM_TLMRENT ();

extern void TL_TLM_TLMREXT ();

extern void TL_TLM_TLMRINI ();

extern void TL_TLM_TLMDINI ();

extern void TL_TLM_TLMDENT ();

extern void TL_TLM_TLMDEXT ();

extern void TL_TLM_TLMDCTWT ();

extern void TL_TLM_TLMCTSIG ();

extern void TL_TLM_TLMCPSIG ();

extern void TL_TLM_TLMCDSIG ();

extern void TL_TLM_TLMCRSIG ();

extern void TL_TLM_TLMCRWT ();

extern void TL_TLM_TLMCDWT ();

extern void TL_TLM_TLMCTWT ();

extern void TL_TLM_TLMCPWT ();

extern void TL_TLM_TLMCRINI ();

extern void TL_TLM_TLMCDINI ();

extern void TL_TLM_TLMCPINI ();

extern void TL_TLM_TLMCTINI ();

extern void TL_TLM_TLMIPINI ();

extern void TL_TLM_TLMIPENT ();

extern void TL_TLM_TLMIPEXT ();

extern void TL_TLM_TLMRFIN ();

extern void TL_TLM_TLMCFIN ();

void TL_TLM () {
    TL_TLM_TLMMLH = (struct TL_TLM_TL_MonitorDescriptor *) 0;
    TL_TLM_TLMMLL = 0;
}
