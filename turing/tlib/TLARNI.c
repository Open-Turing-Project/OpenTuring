...
typedef	TLnat4	TL_TLA___x543[11];
extern TL_TLA___x543	TL_TLA_TLARS;
...
void TL_TLA_TLARNI (answer, lowLimit, highLimit)
TLint4	*answer;
TLint4	lowLimit;
TLint4	highLimit;
{
	...
	TL_TLQUIT("Low value passed to \"randint\" greater than high value", (TLint4) 101);
    };
    TL_TLA_TLARSC(&(value), (TLint4) 0);
    (*answer) = TL_TLA_TLA8FL((TLreal8) (((highLimit - lowLimit) + 1) * value));
    (*answer) += lowLimit;
}
