...
typedef	TLnat4	TL_TLA___x451[11];
extern TL_TLA___x451	TL_TLA_TLARS;
...
TLreal8 TL_TLA_TLA8ML (right, left)
TLreal8	right;
TLreal8	left;
{
    TL_TLQUIT("TLA8ML unimplemented", (TLint4) 60);
    /* NOTREACHED */
}
