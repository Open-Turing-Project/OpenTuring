...
typedef	TLnat4	TL_TLA___x496[11];
extern TL_TLA___x496	TL_TLA_TLARS;
...
TLint4 TL_TLA_TLAIMD (right, left)
TLint4	right;
TLint4	left;
{
    if (right == 0) {
	TL_TLQUIT("Right operand of mod is zero", (TLint4) 33);
    };
