...
typedef	TLaddressint	TL_TLI___x543[21];
typedef	TL_TLI___x543	TL_TLI_ArgList;
typedef	TLchar	TL_TLI___x546[16];
typedef	TL_TLI___x546	TL_TLI___x545[3];
typedef	struct TL_TLI_StreamEntryType	TL_TLI___x547[33];
extern TL_TLI___x547	TL_TLI_TLIS;
...
typedef	TLchar	TL_TLI___x551[42];
extern TL_TLI___x551	TL_TLI_TLIPXL;
typedef	TLchar	TL_TLI___x552[44];
extern TL_TLI___x552	TL_TLI_TLIPXN;
...
void TL_TLI_TLIRE (readItem, itemSize, status, streamNo)
TLaddressint	readItem;
TLint4	itemSize;
TLaddressint	status;
TLint2	streamNo;
{
    TLint4	sizeRead;
    TL_TLI_TLIRER(&(sizeRead), (TLaddressint) readItem, (TLint4) itemSize, (TLaddressint) status, (TLint2) streamNo);
    if (sizeRead < itemSize) {
