...
typedef	TLchar	TL_TLS___x390[3];

extern void TL_TLS_TLSBX ();
typedef	TLchar	TL_TLS___x391[3];

extern void TL_TLS_TLSBXX ();

extern void TL_TLS_TLSCXX ();
void TL_TLS_TLSCXS (source, __x396, startIndex, endOffset, target)
TLchar	source[];
TLint4	__x396;
TLint4	startIndex;
TLint4	endOffset;
TLstring	target;
{
    TL_TLS_TLSCXX(source, (TLint4) __x396, (TLint4) startIndex, (TLint4) (__x396 + endOffset), target);
}
