...
typedef	TLchar	TL_TLS___x385[3];

extern void TL_TLS_TLSBX ();
typedef	TLchar	TL_TLS___x386[3];

extern void TL_TLS_TLSBXX ();

extern void TL_TLS_TLSCXX ();
void TL_TLS_TLSCSX (source, __x390, startOffset, endIndex, target)
TLchar	source[];
TLint4	__x390;
TLint4	startOffset;
TLint4	endIndex;
TLstring	target;
{
    TL_TLS_TLSCXX(source, (TLint4) __x390, (TLint4) (__x390 + startOffset), (TLint4) endIndex, target);
}
