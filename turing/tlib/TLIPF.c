...
typedef	TLaddressint	TL_TLI___x517[21];
typedef	TL_TLI___x517	TL_TLI_ArgList;
typedef	TLchar	TL_TLI___x520[16];
typedef	TL_TLI___x520	TL_TLI___x519[3];
typedef	struct TL_TLI_StreamEntryType	TL_TLI___x521[33];
extern TL_TLI___x521	TL_TLI_TLIS;
...
typedef	TLchar	TL_TLI___x525[42];
extern TL_TLI___x525	TL_TLI_TLIPXL;
typedef	TLchar	TL_TLI___x526[44];
extern TL_TLI___x526	TL_TLI_TLIPXN;
...
void TL_TLI_TLIPF (fWidth, putWidth, putItem, streamNo)
TLint4	fWidth;
TLint4	putWidth;
TLreal8	putItem;
TLint2	streamNo;
{
	...
	{
	    TLstring	__x529;
	    TL_TLS_TLSVFS((TLreal8) putItem, (TLint4) putWidth, (TLint4) fWidth, __x529);
	    (*TL_TLI_TLIFPS)(__x529, (TLaddressint) (TL_TLI_TLIS[streamNo - -2].info));
	};
	TL_TLE_TLEHX();
    }
}
