...
struct TL_TL_HandlerArea	TL_TLE_TLEDEFHA;

extern void TL_TLE_TLEABT ();

extern void TL_TLE_TLETR_TLETRR ();

extern TLint4 TL_TLE_TLECR ();

extern TLint4 TL_TLE_TLECRL ();

extern TLaddressint TL_TLE_TLECRS ();
...
extern TLboolean TL_TLE_TLEHDEF ();

extern void TL_TLE_TLEHX ();

extern void TL_TLE_TLEQUIT ();
