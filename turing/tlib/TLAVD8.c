...
typedef	TLnat4	TL_TLA___x404[11];
extern TL_TLA___x404	TL_TLA_TLARS;
extern TLint4	TL_TLA_TLA8HI;
extern TLint4	TL_TLA_TLA8LO;

extern void TL_TLA_TLAV8D ();
void TL_TLA_TLAVD8 (hiOrder, loOrder, answer)
TLnat4	hiOrder;
TLnat4	loOrder;
TLreal8	*answer;
{
    if (TL_TLA_TLA8HI != TL_TLA_TLA8LO) {
	typedef	TLnat4	__x413[2];
	typedef	__x413	LongArray;
	(* (LongArray *) &(*answer))[TL_TLA_TLA8HI] = hiOrder;
	(* (LongArray *) &(*answer))[TL_TLA_TLA8LO] = loOrder;
    } else {
	TL_TLQUIT("TLAVD8 unimplemented", (TLint4) 60);
    };
}
