...
typedef	TLaddressint	TL_TLI___x564[21];
typedef	TL_TLI___x564	TL_TLI_ArgList;
typedef	TLchar	TL_TLI___x567[16];
typedef	TL_TLI___x567	TL_TLI___x566[3];
typedef	struct TL_TLI_StreamEntryType	TL_TLI___x568[33];
extern TL_TLI___x568	TL_TLI_TLIS;
...
typedef	TLchar	TL_TLI___x572[42];
extern TL_TLI___x572	TL_TLI_TLIPXL;
typedef	TLchar	TL_TLI___x573[44];
extern TL_TLI___x573	TL_TLI_TLIPXN;
...
void TL_TLI_TLIWR (writeItem, itemSize, status, streamNo)
...
{
    TLint4	dummy;
    TL_TLI_TLIWRR(&(dummy), (TLaddressint) writeItem, (TLint4) itemSize, (TLaddressint) status, (TLint2) streamNo);
}
