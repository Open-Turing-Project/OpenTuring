...
typedef	struct TL_TLM_TL_ConditionDescriptor	TL_TLM___x323[65535];
...
TLboolean TL_TLM_TLMCEMP (cd)
struct TL_TLM_TL_ConditionDescriptor	*cd;
{
    return ((cd->signalQ.head) == ((struct TL_TL_ProcessDescriptor *) 0));
    /* NOTREACHED */
}
