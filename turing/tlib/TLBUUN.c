...
extern void TL_TLB_TLBUNR ();
void TL_TLB_TLBUUN (variable, normalizedExpn, unionMap, unionUninitMap)
TLaddressint	variable;
TLint4	normalizedExpn;
TLaddressint	unionMap;
TLaddressint	unionUninitMap;
{
    typedef	TLnat2	__x363[10001];
    typedef	__x363	UnionMapType;
    typedef	TLnat2	__x365[10000];
    typedef	__x365	UnionUninitMapType;
    TLint2	alternative;
    TLaddressint	pat;
    TLaddressint	vari;
    alternative = (* (UnionMapType *) unionMap)[normalizedExpn];
    pat = (TLaddressint) ((unsigned long) unionUninitMap - ((* (UnionUninitMapType *) unionUninitMap)[alternative - 1]));
    vari = (TLaddressint) variable;
    TL_TLB_TLBUNR(&(vari), &(pat), (TLint4) 0);
}
