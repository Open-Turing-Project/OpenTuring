...
typedef	TLnat4	TL_TLA___x423[11];
extern TL_TLA___x423	TL_TLA_TLARS;
...
TLint4 TL_TLA_TLA8CL (value)
TLreal8	value;
{
    if ((value > 0x7FFFFFFF) || (value < -2147483648.0)) {
	TL_TLQUIT("Integer overflow in \"ceil\"", (TLint4) 50);
    };
    if (value > -2147483648.0) {
	return (- TL_TLA_TLA8FL((TLreal8) (- value)));
    } else {
	return (-2147483647);
    };
    /* NOTREACHED */
