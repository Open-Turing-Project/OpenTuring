...
typedef	struct TL_TLM_TL_ConditionDescriptor	TL_TLM___x337[65535];
...
void TL_TLM_TLMDENT (md)
register struct TL_TLM_TL_MonitorDescriptor	*md;
{
    TL_TLK_TLKDMENT((TLint4) (md->monitorPriority));
}
