...
typedef	TLaddressint	TL_TLI___x538[21];
typedef	TL_TLI___x538	TL_TLI_ArgList;
typedef	TLchar	TL_TLI___x541[16];
typedef	TL_TLI___x541	TL_TLI___x540[3];
typedef	struct TL_TLI_StreamEntryType	TL_TLI___x542[33];
extern TL_TLI___x542	TL_TLI_TLIS;
...
typedef	TLchar	TL_TLI___x546[42];
extern TL_TLI___x546	TL_TLI_TLIPXL;
typedef	TLchar	TL_TLI___x547[44];
extern TL_TLI___x547	TL_TLI_TLIPXN;
...
void TL_TLI_TLIRER (sizeRead, readItem, itemSize, status, streamNo)
TLint4	*sizeRead;
...
TLint2	streamNo;
{
    ...
    (*sizeRead) = (*TL_TLI_TLIFRE)((TLaddressint) readItem, (TL_Cint) 1, (TL_Cint) itemSize, (TLaddressint) ((*stream).info));
    if ((unsigned long) status != 0) {
	(* (TLint4 *) status) = 0;
    };
    if ((*sizeRead) == 0) {
