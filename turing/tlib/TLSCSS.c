...
typedef	TLchar	TL_TLS___x380[3];

extern void TL_TLS_TLSBX ();
typedef	TLchar	TL_TLS___x381[3];

extern void TL_TLS_TLSBXX ();

extern void TL_TLS_TLSCXX ();
void TL_TLS_TLSCSS (source, __x384, startOffset, endOffset, target)
TLchar	source[];
TLint4	__x384;
TLint4	startOffset;
TLint4	endOffset;
TLstring	target;
{
    TL_TLS_TLSCXX(source, (TLint4) __x384, (TLint4) (__x384 + startOffset), (TLint4) (__x384 + endOffset), target);
}
