...
typedef	TLnat4	TL_TLA___x431[11];
extern TL_TLA___x431	TL_TLA_TLARS;
...
TLreal8 TL_TLA_TLA8CR (angle)
TLreal8	angle;
{
    if (( TLSIMPLEABS(angle)) > 0.84331486e9) {
	TL_TLQUIT("Argument too large in \"cos\"", (TLint4) 100);
    };
    return (TL_TLA_TLA8T((TLreal8) angle, (TLreal8) (( TLSIMPLEABS(angle)) + 1.57079632679489661923), (TLint4) 1));
    /* NOTREACHED */
}
