...
typedef	struct TL_TLM_TL_ConditionDescriptor	TL_TLM___x367[65535];
...
void TL_TLM_TLMCDINI (name, cdArray, cdArraySize, md)
TLaddressint	name;
TL_TLM___x367	*cdArray;
TLnat4	cdArraySize;
struct TL_TLM_TL_MonitorDescriptor	*md;
{
