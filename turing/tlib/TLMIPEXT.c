...
typedef	struct TL_TLM_TL_ConditionDescriptor	TL_TLM___x385[65535];
...
void TL_TLM_TLMIPEXT (md)
struct TL_TLM_TL_MonitorDescriptor	*md;
{
    TL_TLK_TLKIPEXT((TLaddressint) (md->monitorPriority));
}
