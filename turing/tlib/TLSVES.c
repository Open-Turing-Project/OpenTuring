...
typedef	TLchar	TL_TLS___x441[3];

extern void TL_TLS_TLSBX ();
typedef	TLchar	TL_TLS___x442[3];

extern void TL_TLS_TLSBXX ();

extern void TL_TLS_TLSCXX ();
void TL_TLS_TLSVES (source, width, fWidth, eWidth, target)
TLreal8	source;
TLint4	width;
TLint4	fWidth;
TLint4	eWidth;
...
{
    TLboolean	error;
    if (((width < 0) || (fWidth < 0)) || (eWidth < 0)) {
	TL_TLQUIT("Negative width passed to \"erealstr\"", (TLint4) 67);
    };
    if (((width > 255) || (fWidth >= 255)) || (eWidth >= 255)) {
	TL_TLQUIT("String generated by \"erealstr\" is too long", (TLint4) 93);
    };
    TL_TLA_TLAVES((TLreal8) source, (TLint4) width, (TLint4) fWidth, (TLint4) eWidth, target, (TLboolean) 0, &(error));
    if (error) {
	TL_TLQUIT("String generated by \"erealstr\" is too long", (TLint4) 93);
    };
}
