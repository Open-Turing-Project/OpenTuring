...
typedef	TLaddressint	TL_TLI___x566[21];
typedef	TL_TLI___x566	TL_TLI_ArgList;
typedef	TLchar	TL_TLI___x569[16];
typedef	TL_TLI___x569	TL_TLI___x568[3];
typedef	struct TL_TLI_StreamEntryType	TL_TLI___x570[33];
extern TL_TLI___x570	TL_TLI_TLIS;
...
typedef	TLchar	TL_TLI___x574[42];
extern TL_TLI___x574	TL_TLI_TLIPXL;
typedef	TLchar	TL_TLI___x575[44];
extern TL_TLI___x575	TL_TLI_TLIPXN;
...
TLaddressint TL_TLI_TLIGF (streamNo)
TLint4	streamNo;
{
    return (TL_TLI_TLIS[streamNo - -2].info);
    /* NOTREACHED */
}
