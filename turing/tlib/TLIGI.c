...
typedef	TLaddressint	TL_TLI___x457[21];
typedef	TL_TLI___x457	TL_TLI_ArgList;
typedef	TLchar	TL_TLI___x460[16];
typedef	TL_TLI___x460	TL_TLI___x459[3];
typedef	struct TL_TLI_StreamEntryType	TL_TLI___x461[33];
extern TL_TLI___x461	TL_TLI_TLIS;
...
typedef	TLchar	TL_TLI___x465[42];
extern TL_TLI___x465	TL_TLI_TLIPXL;
typedef	TLchar	TL_TLI___x466[44];
extern TL_TLI___x466	TL_TLI_TLIPXN;
...
extern void TL_TLI_TLIFS ();
void TL_TLI_TLIGI (getItem, itemSize, streamNo)
...
TLint2	streamNo;
{
	...
	if (itemSize == 2) {
	    ...
	    if (((* (TLint2 *) getItem)) != value) {
		TL_TLQUIT("Integer value too large for int2 variable", (TLint4) 70);
	    };
	} else {
	    (* (TLint1 *) getItem) = value;
	    if (((* (TLint1 *) getItem)) != value) {
		TL_TLQUIT("Integer value too large for int1 variable", (TLint4) 70);
	    };
	};
    };
}
