...
typedef	TLchar	TL_TLS___x446[3];

extern void TL_TLS_TLSBX ();
typedef	TLchar	TL_TLS___x447[3];

extern void TL_TLS_TLSBXX ();

extern void TL_TLS_TLSCXX ();
void TL_TLS_TLSVFS (source, width, fWidth, target)
TLreal8	source;
TLint4	width;
TLint4	fWidth;
TLstring	target;
{
    TLboolean	error;
    if ((width < 0) || (fWidth < 0)) {
	TL_TLQUIT("Negative width passed to \"frealstr\"", (TLint4) 67);
    };
    if ((width > 255) || (fWidth >= 255)) {
	TL_TLQUIT("String generated by \"frealstr\" is too long", (TLint4) 93);
    };
    TL_TLA_TLAVFS((TLreal8) source, (TLint4) width, (TLint4) fWidth, target, (TLboolean) 0, &(error));
    if (error) {
	TL_TLQUIT("String generated by \"frealstr\" is too long", (TLint4) 93);
    };
}
