...
typedef	TLnat4	TL_TLA___x561[11];
extern TL_TLA___x561	TL_TLA_TLARS;
...
TLnat4	value;
{
    ...
    TLnat4	hiOrder;
    TLnat4	loOrder;
    exponent = (value & 2139095040) >> 23;
    mantissa = (value & 8388607) >> 0;
    if ((exponent == 0) && (mantissa == 0)) {
	typedef	TLnat4	__x570[2];
	typedef	__x570	LongArray;
	(* (LongArray *) &answer)[0] = 0;
	(* (LongArray *) &answer)[1] = 0;
	return (answer);
    };
    hiOrder = (((TLint4) ((value & (TLint4) -0x80000000) >> 31) << 31) & (TLint4) -0x80000000) | (hiOrder & 2147483647);
    hiOrder = (((TLint4) (exponent + (896)) << 20) & 2146435072) | (hiOrder & -2146435073);
    hiOrder = (((TLint4) (mantissa >> (3)) << 0) & 1048575) | (hiOrder & -1048576);
    loOrder = (TLint4) mantissa << ((32 + 20) - 23);
