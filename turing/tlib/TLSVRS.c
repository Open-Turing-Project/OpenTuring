...
void TL_TLS_TLSVRS (value, width, target)
TLreal8	value;
TLint4	width;
TLstring	target;
{
    ...
    TLboolean	error;
    if (width < 0) {
	TL_TLQUIT("Negative width passed to \"realstr\"", (TLint4) 67);
    };
    if (width > 255) {
	TL_TLQUIT("String generated by \"realstr\" is too long", (TLint4) 93);
    };
    absValue =  TLSIMPLEABS(value);
    if (((absValue >= 1e-3) && (absValue < 1e6)) || (value == 0)) {
	TL_TLA_TLAVFS((TLreal8) value, (TLint4) width, (TLint4) 6, target, (TLboolean) 1, &(error));
    } else {
	TL_TLA_TLAVES((TLreal8) value, (TLint4) width, (TLint4) 6, (TLint4) 2, target, (TLboolean) 1, &(error));
    };
    if (error) {
	TL_TLQUIT("String generated by \"realstr\" is too long", (TLint4) 93);
    };
