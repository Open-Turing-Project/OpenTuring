...
typedef	TLnat4	TL_TLA___x583[11];
extern TL_TLA___x583	TL_TLA_TLARS;
...
TLint4	value;
{
    ...
    if (value < 0) {
	absValue = - value;
	(* (TLreal4 *) &answer) = absValue;
	answer = (((TLint4) 1 << 31) & (TLint4) -0x80000000) | (answer & 2147483647);
    } else {
	absValue = value;
	(* (TLreal4 *) &answer) = absValue;
    };
