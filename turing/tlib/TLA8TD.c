...
typedef	TLnat4	TL_TLA___x479[11];
extern TL_TLA___x479	TL_TLA_TLARS;
...
TLreal8 TL_TLA_TLA8TD (value)
TLreal8	value;
{
    return (TL_TLA_TLA8TR((TLreal8) value) * 57.295779513082320876798946);
    /* NOTREACHED */
}
