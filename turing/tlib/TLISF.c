...
typedef	TLaddressint	TL_TLI___x569[21];
typedef	TL_TLI___x569	TL_TLI_ArgList;
typedef	TLchar	TL_TLI___x572[16];
typedef	TL_TLI___x572	TL_TLI___x571[3];
typedef	struct TL_TLI_StreamEntryType	TL_TLI___x573[33];
extern TL_TLI___x573	TL_TLI_TLIS;
...
typedef	TLchar	TL_TLI___x577[42];
extern TL_TLI___x577	TL_TLI_TLIPXL;
typedef	TLchar	TL_TLI___x578[44];
extern TL_TLI___x578	TL_TLI_TLIPXN;
...
void TL_TLI_TLISF (streamNo, info)
TLint4	streamNo;
TLaddressint	info;
{
    TL_TLI_TLIS[streamNo - -2].info = (TLaddressint) info;
}
