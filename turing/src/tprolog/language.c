...
static struct {
    ...
    '/', 'e', 'x', 'p', 'o', 'r', 't', '/', 'h', 'o', 'm', 'e', '/', 't', 'u', 'r', 'i', 'n', 'g', '/', 'o', 'o', 't', '/', 's', 'r', 'c', '/', 'l', 'a', 'n', 'g', 'u', 'a', 'g', 'e', '/', 'l', 'o', 'a', 'd', 'f', 'i', 'l', 'e', '.', 'i', 'n', '\0'
    }};
...
static void Language_Reset ();

static void Language_SetMaxErrorCount ();
typedef	TLstring	__x866[20];

void Language_EnterPreprocSymbols ();

static void Language_CompileUnit ();

static void Language_CompileProgram ();

static void Language_WriteObjectFile ();
typedef	TLstring	__x869[21];

void Language_SetupExecutionFromObjectFile ();

void Language_GetFileName ();
typedef	TLstring	__x873[21];

static void Language_SetupExecution ();
...
struct	Language___x877 {
    TLint4	lower, range;
};
typedef	struct Language___x877	Language___x876[255];
...
typedef	TLstring	Language___x885[20];
static Language___x885	Language_preprocDefs;
...
TLint4	numDefs;
{
    ...
    TLSETF();
    TLSETL(100193);
    TLNONSCLASS(Language_preprocDefs, defs, Language___x885);
    TLINCL();
