...
struct	Language___x1588 {
    TLint4	lower, range;
};
typedef	struct Language___x1588	Language___x1587[255];
struct	Language_ArrayDescriptor {
    TLnat4	sizeArray;
    TLnat4	sizeElement;
    TLnat4	elementCount;
    TLnat4	numDimensions;
    Language___x1587	dim;
};
...
typedef	TLnat1	Language_Execute_ExecutionError___x1596[1];
struct	Language_Execute_ExecutionError_TL_HandlerArea {
    ...
    Language_Execute_ExecutionError___x1596	savedState;
};
...
typedef	struct Language_Execute_ExecutionError_TL_ConditionDescriptor	Language_Execute_ExecutionError___x1599[65535];
...
typedef	TLint1	Language_Execute___x1601[23];
extern Language_Execute___x1601	Language_Execute_fileMap;
typedef	Language_StringDef	*Language_Execute___x1604[21];
extern Language_Execute___x1604	Language_Execute_argumentNames;
...
typedef	struct Language_Execute_ConditionDescriptor	Language_Execute___x1605[65535];
struct	Language_Execute_ConditionDefinition {
    TLnat2	cdArraySize;
    Language_Execute___x1605	*cdArray;
    TLaddressint	name;
...
typedef	Language_Opcode	Language_Execute___x1606[1];
extern Language_Execute___x1606	Language_Execute_nullRoutine;
...
struct	Language_Execute___x1613 {
    TLint4	streamNo;
    TLstring	msg;
    struct SrcPosition	srcPos;
};
typedef	struct Language_Execute___x1613	Language_Execute___x1612[10];
