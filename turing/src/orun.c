...
typedef	TLstring	__x2279[21];
typedef	TLstring	__x2283[21];
...
typedef	TLchar	Language___x2287[22];
typedef	Language___x2287	Language___x2286[255];
extern Language___x2286	Language_OpcodeName;
struct	Language_CodeHeader {
    TLaddressint	bodyCode;
};
struct	Language___x2289 {
    TLint4	lower, range;
};
typedef	struct Language___x2289	Language___x2288[255];
struct	Language_ArrayDescriptor {
    TLnat4	sizeArray;
    TLnat4	sizeElement;
    TLnat4	elementCount;
    TLnat4	numDimensions;
    Language___x2288	dim;
};
...
typedef	TLnat1	Language_Execute_ExecutionError___x2300[1];
struct	Language_Execute_ExecutionError_TL_HandlerArea {
    ...
    Language_Execute_ExecutionError___x2300	savedState;
};
...
typedef	struct Language_Execute_ExecutionError_TL_ConditionDescriptor	Language_Execute_ExecutionError___x2303[65535];
...
typedef	TLint1	Language_Execute___x2305[23];
extern Language_Execute___x2305	Language_Execute_fileMap;
typedef	Language_StringDef	*Language_Execute___x2308[21];
extern Language_Execute___x2308	Language_Execute_argumentNames;
...
typedef	struct Language_Execute_ConditionDescriptor	Language_Execute___x2323[65535];
struct	Language_Execute_ConditionDefinition {
    TLnat2	cdArraySize;
    Language_Execute___x2323	*cdArray;
    TLaddressint	name;
...
typedef	Language_Opcode	Language_Execute___x2324[1];
extern Language_Execute___x2324	Language_Execute_nullRoutine;
...
struct Language_Execute_RunDescriptor	*runDesc;
{
	...
	for(;;) {
		...
		case 13:
			...
			if (((unsigned long) Language_Execute_globalSP - (unsigned long) (Language_Execute_RQHead->minimumSP)) < cSize) {
			    {
				TLstring	__x2670;
				TL_TLS_TLSVIS((TLint4) Language_Execute_stackAllocated, (TLint4) 1, (TLint4) 10, __x2670);
				{
				    TLstring	__x2669;
				    TL_TLS_TLSVIS((TLint4) ((unsigned long) Language_Execute_globalSP - (unsigned long) (Language_Execute_RQHead->minimumSP)), (TLint4) 1, (TLint4) 10, __x2669);
				    {
					TLstring	__x2668;
					TL_TLS_TLSVIS((TLint4) cSize, (TLint4) 1, (TLint4) 10, __x2668);
					{
					    TLstring	__x2667;
					    TL_TLS_TLSCAT("Stack overflow during dynamic allocation.  ", "Attempted to allocate ", __x2667);
					    {
						TLstring	__x2666;
						TL_TLS_TLSCAT(__x2667, __x2668, __x2666);
						{
						    TLstring	__x2665;
						    TL_TLS_TLSCAT(__x2666, " bytes in dynamic array with ", __x2665);
						    {
							TLstring	__x2664;
							TL_TLS_TLSCAT(__x2665, __x2669, __x2664);
							{
							    TLstring	__x2663;
							    TL_TLS_TLSCAT(__x2664, " bytes left of stack space. (Original stack size: ", __x2663);
							    {
								TLstring	__x2662;
								TL_TLS_TLSCAT(__x2663, __x2670, __x2662);
								{
								    TLstring	__x2661;
								    TL_TLS_TLSCAT(__x2662, " bytes)", __x2661);
								    Language_Execute_ExecutionError_Abort((TLint4) 10000, __x2661);
								};
							    };
							};
						    };
		...
		case 14:
			...
			if (((unsigned long) Language_Execute_globalSP - (unsigned long) (Language_Execute_RQHead->minimumSP)) < ((*desc).sizeArray)) {
			    {
				TLstring	__x2685;
				TL_TLS_TLSVIS((TLint4) Language_Execute_stackAllocated, (TLint4) 1, (TLint4) 10, __x2685);
				{
				    TLstring	__x2684;
				    TL_TLS_TLSVIS((TLint4) ((unsigned long) Language_Execute_globalSP - (unsigned long) (Language_Execute_RQHead->minimumSP)), (TLint4) 1, (TLint4) 10, __x2684);
				    {
					TLstring	__x2683;
					TL_TLS_TLSVIS((TLint4) ((*desc).sizeArray), (TLint4) 1, (TLint4) 10, __x2683);
					{
					    TLstring	__x2682;
					    TL_TLS_TLSCAT("Stack overflow during dynamic allocation.  ", "Attempted to allocate ", __x2682);
					    {
						TLstring	__x2681;
						TL_TLS_TLSCAT(__x2682, __x2683, __x2681);
						{
						    TLstring	__x2680;
						    TL_TLS_TLSCAT(__x2681, " bytes in dynamic array with ", __x2680);
						    {
							TLstring	__x2679;
							TL_TLS_TLSCAT(__x2680, __x2684, __x2679);
							{
							    TLstring	__x2678;
							    TL_TLS_TLSCAT(__x2679, " bytes left of stack space. (Original stack size: ", __x2678);
							    {
								TLstring	__x2677;
								TL_TLS_TLSCAT(__x2678, __x2685, __x2677);
								{
								    TLstring	__x2676;
								    TL_TLS_TLSCAT(__x2677, " bytes)", __x2676);
								    Language_Execute_ExecutionError_Abort((TLint4) 10000, __x2676);
								};
							    };
							};
						    };
    ...
    void 	(*procRoutine)();
			...
			typedef	struct LookupEntry	__x2799[10000];
			typedef	__x2799	LookupTable;
		...
		case 54:
			...
			{
			    TLstring	__x2813;
			    TL_TLS_TLSCAT((* (TLstring *) l), (* (TLstring *) r), __x2813);
			    TLSTRASS(255, (* (TLstring *) t), __x2813);
			};
			Language_Execute_globalSP += 8;
		...
		case 66:
			...
			(*newDesc).numDimensions = (*oldDesc).numDimensions;
			{
			    register TLint4	i;
			    TLint4	__x2837;
			    __x2837 = (*oldDesc).numDimensions;
			    i = 1;
			    if (i <= __x2837) {
				for(;;) {
				    TLSTRCTASS((*newDesc).dim[TLINRANGELOW(i, 1, 255, 1)], (*oldDesc).dim[TLINRANGELOW(i, 1, 255, 1)], struct Language___x2289);
				    if (i == __x2837) break;
				    i++;
				}
			    };
		...
		case 86:
		    {
			{
			    TLTMPPOINTER((*__x2870), &((* (TLint4 *) ((unsigned long) Language_Execute_globalSP + 4))), TLint4);
			    (*__x2870) = TL_TLA_TLAPII((TLint4) ((* (TLint4 *) Language_Execute_globalSP)), (TLint4) (*__x2870));
			};
			Language_Execute_globalSP += 4;
		    }
		    break;
		case 87:
		    {
			{
			    TLTMPPOINTER((*__x2872), &((* (TLreal8 *) ((unsigned long) Language_Execute_globalSP + 4))), TLreal8);
			    (*__x2872) = TL_TLA_TLAPRI((TLint4) ((* (TLint4 *) Language_Execute_globalSP)), (TLreal8) (*__x2872));
			};
			Language_Execute_globalSP += 4;
		    }
		    break;
		case 88:
		    {
			{
			    TLTMPPOINTER((*__x2874), &((* (TLreal8 *) ((unsigned long) Language_Execute_globalSP + 8))), TLreal8);
			    (*__x2874) = TL_TLA_TLAPRR((TLreal8) ((* (TLreal8 *) Language_Execute_globalSP)), (TLreal8) (*__x2874));
			};
			Language_Execute_globalSP += 8;
		    }
		    break;
		...
		case 108:
			...
			if (((* (Language_Offset *) Language_Execute_globalPC)) != 0) {
			    {
				TLint4	__x2938;
				__x2938 = (unsigned long) ((*p).dataPtr) + ((* (Language_Offset *) Language_Execute_globalPC));
				Language_Execute_Kernel_MonitorFree((* (struct Language_Execute_MonitorDescriptor * *) &__x2938));
			    };
			};
		...
		case 109:
			...
			if (((* (Language_Offset *) Language_Execute_globalPC)) != 0) {
			    {
				TLint4	__x2945;
				__x2945 = (unsigned long) (p.dataPtr) + ((* (Language_Offset *) Language_Execute_globalPC));
				Language_Execute_Kernel_MonitorFree((* (struct Language_Execute_MonitorDescriptor * *) &__x2945));
			    };
			};
			Language_Execute_Heap_Free(&(p));
			Language_Execute_globalSP += 4;
		...
		case 125:
			...
			if (Language_debug) {
			    {
				TLstring	__x3004;
				FileManager_FileName((FileManager_FileNoType) (Language_Execute_RQHead->srcPos.fileNo), __x3004);
				TL_TLI_TLISS ((TLint4) 0, (TLint2) 2);
				...
				TL_TLI_TLIPS ((TLint4) 0, __x3004, (TLint2) 0);
				TL_TLI_TLIPS ((TLint4) 0, "\"", (TLint2) 0);
				TL_TLI_TLIPK ((TLint2) 0);
			    };
			};
		...
		case 135:
			...
			{
			    TLstring	__x3033;
			    TL_TLS_TLSVIS((TLint4) ((* (TLint4 *) (((unsigned long) Language_Execute_globalSP + 4) + (2 * 4)))), (TLint4) ((* (TLint4 *) (((unsigned long) Language_Execute_globalSP + 4) + 4))), (TLint4) ((* (TLint4 *) ((unsigned long) Language_Execute_globalSP + 4))), __x3033);
			    TLSTRASS(255, (* (TLstring *) tAddr), __x3033);
			};
			Language_Execute_globalSP += 12;
		...
		case 186:
			...
			if (((unsigned long) Language_Execute_globalSP < (unsigned long) (Language_Execute_RQHead->minimumSP)) || (((unsigned long) Language_Execute_globalSP - (unsigned long) (Language_Execute_RQHead->minimumSP)) <= (((2 * 2) + 4) + localSize))) {
			    {
				TLstring	__x3192;
				TL_TLS_TLSVIS((TLint4) Language_Execute_stackAllocated, (TLint4) 1, (TLint4) 10, __x3192);
				{
				    TLstring	__x3191;
				    TL_TLS_TLSVIS((TLint4) ((unsigned long) Language_Execute_globalSP - (unsigned long) (Language_Execute_RQHead->minimumSP)), (TLint4) 1, (TLint4) 10, __x3191);
				    {
					TLstring	__x3190;
					TL_TLS_TLSVIS((TLint4) localSize, (TLint4) 1, (TLint4) 10, __x3190);
					{
					    TLstring	__x3189;
					    TL_TLS_TLSCAT("Stack overflow! ", "Attempted to allocate ", __x3189);
					    {
						TLstring	__x3188;
						TL_TLS_TLSCAT(__x3189, __x3190, __x3188);
						{
						    TLstring	__x3187;
						    TL_TLS_TLSCAT(__x3188, " bytes of local variables with ", __x3187);
						    {
							TLstring	__x3186;
							TL_TLS_TLSCAT(__x3187, __x3191, __x3186);
							{
							    TLstring	__x3185;
							    TL_TLS_TLSCAT(__x3186, " bytes left of stack space. (Original stack size: ", __x3185);
							    {
								TLstring	__x3184;
								TL_TLS_TLSCAT(__x3185, __x3192, __x3184);
								{
								    TLstring	__x3183;
								    TL_TLS_TLSCAT(__x3184, " bytes)", __x3183);
								    Language_Execute_ExecutionError_Abort((TLint4) 10000, __x3183);
								};
							    };
							};
						    };
		...
		case 205:
			...
			if ((unsigned long) fp == 0) {
				...
				{
				    TLstring	__x3234;
				    FileManager_FileName((FileManager_FileNoType) newFileNo, __x3234);
				    TL_TLI_TLISS ((TLint4) 0, (TLint2) 2);
				    TL_TLI_TLIPS ((TLint4) 0, "line ", (TLint2) 0);
				    TL_TLI_TLIPN ((TLint4) 0, (TLnat4) newLineNo, (TLint2) 0);
				    TL_TLI_TLIPS ((TLint4) 0, " of \"", (TLint2) 0);
				    TL_TLI_TLIPS ((TLint4) 0, __x3234, (TLint2) 0);
				    TL_TLI_TLIPS ((TLint4) 0, "\"", (TLint2) 0);
				    TL_TLI_TLIPK ((TLint2) 0);
				};
			    };
		...
		case 208:
			...
			if (stream == -3) {
			    {
				TLstring	__x3241;
				TL_TLS_TLSVIS((TLint4) TL_TLI_TLIXSN, (TLint4) 1, (TLint4) 10, __x3241);
				{
				    TLstring	__x3240;
				    TL_TLS_TLSCAT("I/O attempted on closed stream ", __x3241, __x3240);
				    Language_Execute_ExecutionError_Abort((TLint4) 10000, __x3240);
				};
			    };
			};
		...
		case 209:
			...
			if (stream == -3) {
			    {
				TLstring	__x3246;
				TL_TLS_TLSVIS((TLint4) TL_TLI_TLIXSN, (TLint4) 1, (TLint4) 10, __x3246);
				{
				    TLstring	__x3245;
				    TL_TLS_TLSCAT("I/O attempted on closed stream ", __x3246, __x3245);
				    Language_Execute_ExecutionError_Abort((TLint4) 10000, __x3245);
				};
			    };
			};
		...
		case 213:
			...
			if (Language_debug) {
			    {
				TLstring	__x3262;
				FileManager_FileName((FileManager_FileNoType) newFileNo, __x3262);
				TL_TLI_TLISS ((TLint4) 0, (TLint2) 2);
				TL_TLI_TLIPS ((TLint4) 0, "line ", (TLint2) 0);
				TL_TLI_TLIPN ((TLint4) 0, (TLnat4) newLineNo, (TLint2) 0);
				TL_TLI_TLIPS ((TLint4) 0, " of \"", (TLint2) 0);
				TL_TLI_TLIPS ((TLint4) 0, __x3262, (TLint2) 0);
				TL_TLI_TLIPS ((TLint4) 0, "\"", (TLint2) 0);
				TL_TLI_TLIPK ((TLint2) 0);
			    };
			};
		...
		case 214:
			...
			if (Language_debug) {
			    {
				TLstring	__x3264;
				FileManager_FileName((FileManager_FileNoType) (Language_Execute_RQHead->srcPos.fileNo), __x3264);
				TL_TLI_TLISS ((TLint4) 0, (TLint2) 2);
				TL_TLI_TLIPS ((TLint4) 0, "line ", (TLint2) 0);
				TL_TLI_TLIPN ((TLint4) 0, (TLnat4) newLineNo, (TLint2) 0);
				TL_TLI_TLIPS ((TLint4) 0, " of \"", (TLint2) 0);
				TL_TLI_TLIPS ((TLint4) 0, __x3264, (TLint2) 0);
				TL_TLI_TLIPS ((TLint4) 0, "\"", (TLint2) 0);
				TL_TLI_TLIPK ((TLint2) 0);
			    };
			};
		...
		case 231:
			...
			accum = 0;
			{
			    register TLint4	i;
			    TLint4	__x3295;
			    __x3295 = (*desc).numDimensions;
			    i = 1;
			    if (i <= __x3295) {
				for(;;) {
				    TLBINDREG((*dim), struct Language___x2289);
				    TLint4	subscr;
		...
		case 233:
			...
			{
			    TLchar	__x3318[2];
			    TL_TLS_TLSBX(__x3318, (TLint4) Index, ((* (TLstring *) sAddr)));
			    TLSTRASS(1, (* (Language_string1 *) tAddr), __x3318);
			};
			Language_Execute_globalSP += 8;
			(* (TLaddressint *) Language_Execute_globalSP) = (TLaddressint) tAddr;
			Language_Execute_globalPC += Language_codeInt1Size;
		...
		case 234:
			...
			{
			    TLstring	__x3329;
			    TL_TLS_TLSBXX(__x3329, (TLint4) lastIndex, (TLint4) firstIndex, ((* (TLstring *) sAddr)));
			    TLSTRASS(255, (* (TLstring *) tAddr), __x3329);
			};
			Language_Execute_globalSP += 12;
			(* (TLaddressint *) Language_Execute_globalSP) = (TLaddressint) tAddr;
			Language_Execute_globalPC += Language_codeInt1Size;
		...
		case 253:
			...
			if (exitCode != 0) {
			    {
				TLstring	__x3336;
				TL_TLS_TLSVIS((TLint4) exitCode, (TLint4) 1, (TLint4) 10, __x3336);
				{
				    TLstring	__x3335;
				    TL_TLS_TLSCAT("Program exit code ", __x3336, __x3335);
				    Language_ErrorModule_Message(&(Language_Execute_RQHead->srcPos), (Language_ErrorModule_Severity) 2, __x3335);
				};
			    };
			};
			(*runDesc).state = 0;
		...
		case 237:
			...
			if (stream == -3) {
			    {
				TLstring	__x3349;
				TL_TLS_TLSVIS((TLint4) TL_TLI_TLIXSN, (TLint4) 1, (TLint4) 10, __x3349);
				{
				    TLstring	__x3348;
				    TL_TLS_TLSCAT("I/O attempted on closed stream ", __x3349, __x3348);
				    Language_Execute_ExecutionError_Abort((TLint4) 10000, __x3348);
				};
			    };
			};
		...
		case 249:
			...
			if (stream == -3) {
			    {
				TLstring	__x3390;
				TL_TLS_TLSVIS((TLint4) TL_TLI_TLIXSN, (TLint4) 1, (TLint4) 10, __x3390);
				{
				    TLstring	__x3389;
				    TL_TLS_TLSCAT("I/O attempted on closed stream ", __x3390, __x3389);
				    Language_Execute_ExecutionError_Abort((TLint4) 10000, __x3389);
				};
			    };
			};
		...
		case 61:
			...
			if (TL_TLS_TLSLEN(((* (TLstring *) ((* (TLaddressint *) Language_Execute_globalSP))))) > ((* (TLint4 *) Language_Execute_globalPC))) {
			    {
				TLstring	__x3452;
				TL_TLS_TLSVIS((TLint4) ((* (TLint4 *) Language_Execute_globalPC)), (TLint4) 1, (TLint4) 10, __x3452);
				{
				    TLstring	__x3450;
				    TL_TLS_TLSCAT("Length of char(n) parameter is not ", __x3452, __x3450);
				    Language_Execute_ExecutionError_Abort((TLint4) 10000, __x3450);
				};
			    };
			};
			Language_Execute_globalPC += Language_codeIntSize;
		...
		case 68:
			...
			if (((* (TLint4 *) ((unsigned long) Language_Execute_globalSP + 4))) >= 256) {
			    {
				TLstring	__x3468;
				TL_TLS_TLSVIS((TLint4) ((* (TLint4 *) ((unsigned long) Language_Execute_globalSP + 4))), (TLint4) 1, (TLint4) 10, __x3468);
				{
				    TLstring	__x3466;
				    TL_TLS_TLSCAT("char(n) size of ", __x3468, __x3466);
				    {
					TLstring	__x3465;
					TL_TLS_TLSCAT(__x3466, " is too large to convert to string", __x3465);
					Language_Execute_ExecutionError_Abort((TLint4) 10000, __x3465);
				    };
				};
			    };
			};
			{
			    register TLint4	__x2215;
			    TLint4	__x3470;
			    __x3470 = (* (TLint4 *) ((unsigned long) Language_Execute_globalSP + 4));
			    __x2215 = 1;
			    if (__x2215 <= __x3470) {
				for(;;) {
				    value = (* (TLnat1 *) sAddr);
		...
		case 69:
			...
			if (((* (TLint4 *) ((unsigned long) Language_Execute_globalSP + 4))) >= 256) {
			    {
				TLstring	__x3482;
				TL_TLS_TLSVIS((TLint4) ((* (TLint4 *) ((unsigned long) Language_Execute_globalSP + 4))), (TLint4) 1, (TLint4) 10, __x3482);
				{
				    TLstring	__x3480;
				    TL_TLS_TLSCAT("char(n) size of ", __x3482, __x3480);
				    {
					TLstring	__x3479;
					TL_TLS_TLSCAT(__x3480, " is too large to convert to string", __x3479);
					Language_Execute_ExecutionError_Abort((TLint4) 10000, __x3479);
				    };
				};
			    };
			};
			{
			    register TLint4	__x2219;
			    TLint4	__x3484;
			    __x3484 = (* (TLint4 *) ((unsigned long) Language_Execute_globalSP + 4));
			    __x2219 = 1;
			    if (__x2219 <= __x3484) {
				for(;;) {
				    value = (* (TLnat1 *) sAddr);
		...
		case 79:
			...
			(* (TLint4 *) Language_Execute_globalSP) = 1;
			{
			    register TLint4	__x2223;
			    TLint4	__x3499;
			    __x3499 = (* (Language_Offset *) Language_Execute_globalPC);
			    __x2223 = 1;
			    if (__x2223 <= __x3499) {
				for(;;) {
		...
		case 107:
			...
			if ((unsigned long) stackBase == 0) {
			    ...
			    {
				register TLint4	__x2240;
				TLint4	__x3539;
				__x3539 = formalSize >> 2;
				__x2240 = 1;
				if (__x2240 <= __x3539) {
				    for(;;) {
		...
		case 111:
			...
			TLASSERT (((unsigned long) Language_Execute_globalPC & (3)) == 0);
			{
			    register TLint4	__x2243;
			    TLint4	__x3551;
			    __x3551 = (* (Language_Offset *) Language_Execute_globalPC);
			    __x2243 = 1;
			    if (__x2243 <= __x3551) {
				for(;;) {
				    if (((* (TLchar *) r)) < ((* (TLchar *) l))) {
		...
		case 139:
			...
			TLASSERT (((unsigned long) Language_Execute_globalPC & (3)) == 0);
			{
			    register TLint4	__x2246;
			    TLint4	__x3583;
			    __x3583 = (* (Language_Offset *) Language_Execute_globalPC);
			    __x2246 = 1;
			    if (__x2246 <= __x3583) {
				for(;;) {
				    if (((* (TLchar *) r)) > ((* (TLchar *) l))) {
		...
		case 171:
			...
			{
			    TLstring	__x3626;
			    TL_TLS_TLSVNS((TLnat4) ((* (TLnat4 *) (((unsigned long) Language_Execute_globalSP + 4) + (2 * 4)))), (TLint4) ((* (TLint4 *) (((unsigned long) Language_Execute_globalSP + 4) + 4))), (TLint4) ((* (TLint4 *) ((unsigned long) Language_Execute_globalSP + 4))), __x3626);
			    TLSTRASS(255, (* (TLstring *) tAddr), __x3626);
			};
			Language_Execute_globalSP += 12;
			(* (TLaddressint *) Language_Execute_globalSP) = (TLaddressint) tAddr;
		    }
		...
		if (Language_Execute_processCount > 0) {
			...
			if (Language_debug) {
			    {
				TLstring	__x3692;
				FileManager_FileName((FileManager_FileNoType) (me->srcPos.fileNo), __x3692);
				TL_TLI_TLISS ((TLint4) 0, (TLint2) 2);
				TL_TLI_TLIPS ((TLint4) 0, "line ", (TLint2) 0);
				TL_TLI_TLIPN ((TLint4) 0, (TLnat4) (me->srcPos.lineNo), (TLint2) 0);
				TL_TLI_TLIPS ((TLint4) 0, " of \"", (TLint2) 0);
				TL_TLI_TLIPS ((TLint4) 0, __x3692, (TLint2) 0);
				TL_TLI_TLIPS ((TLint4) 0, "\"", (TLint2) 0);
				TL_TLI_TLIPK ((TLint2) 0);
			    };
			};
	    ...
	    if (Language_Execute_executionTimeout <= 0) {
		(*runDesc).state = 1;
		break;
	    };
	}
