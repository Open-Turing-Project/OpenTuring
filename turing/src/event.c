...
typedef	TLstring	__x1837[21];
typedef	TLstring	__x1841[21];
...
typedef	TLchar	Language___x1845[22];
typedef	Language___x1845	Language___x1844[255];
extern Language___x1844	Language_OpcodeName;
struct	Language_CodeHeader {
    TLaddressint	bodyCode;
};
struct	Language___x1847 {
    TLint4	lower, range;
};
typedef	struct Language___x1847	Language___x1846[255];
struct	Language_ArrayDescriptor {
    TLnat4	sizeArray;
    TLnat4	sizeElement;
    TLnat4	elementCount;
    TLnat4	numDimensions;
    Language___x1846	dim;
};
...
typedef	TLnat1	Language_Execute_ExecutionError___x1858[1];
struct	Language_Execute_ExecutionError_TL_HandlerArea {
    ...
    Language_Execute_ExecutionError___x1858	savedState;
};
...
typedef	struct Language_Execute_ExecutionError_TL_ConditionDescriptor	Language_Execute_ExecutionError___x1861[65535];
...
typedef	TLint1	Language_Execute___x1863[23];
extern Language_Execute___x1863	Language_Execute_fileMap;
typedef	Language_StringDef	*Language_Execute___x1866[21];
extern Language_Execute___x1866	Language_Execute_argumentNames;
...
typedef	struct Language_Execute_ConditionDescriptor	Language_Execute___x1881[65535];
struct	Language_Execute_ConditionDefinition {
    TLnat2	cdArraySize;
    Language_Execute___x1881	*cdArray;
    TLaddressint	name;
...
typedef	Language_Opcode	Language_Execute___x1882[1];
extern Language_Execute___x1882	Language_Execute_nullRoutine;
